...
const TravelDateSection = ({
  ...
  return (
    <div className={`${gradientClasses} pt-3 pb-4 px-6 flex flex-col items-center ${isArrival ? 'border-b' : 'border-t'} border-base-300/20 relative`}>
      ...
      <div className="flex items-center gap-2 mb-3">
        ...
        {confirmed ? (
          ...
          <AlertCircle className="h-4 w-4 text-orange-400 opacity-60 ml-1" aria-label={`${label} not confirmed yet`} />
        )}
      </div>
